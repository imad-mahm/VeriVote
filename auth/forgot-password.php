...
if (is_post_request()) {
    ...
    if ($user) {
        ...
        log_activity('password_reset.requested', [
            'user_id' => (int) $user['id'],
        ]);
        ...
        log_activity('password_reset.unknown_email', [
            'email' => $email,
        ], 'WARN');
    }
...
<section class="section">
    <article class="panel" data-reveal>
        ...
        <p>If the address exists, we'll email a reset link. Check your inbox (and spam folder).</p>
