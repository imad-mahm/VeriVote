...
<?php if (empty($user['phone_verified_at'])): ?>
    <div class="alert alert--warning">
        Your phone number is still unverified. <a href="<?= e(base_url('/auth/verify-email.php')); ?>">Verify it now</a> to unlock event registration.
    </div>
<?php endif; ?>
...
<section class="grid-2">
    <article class="table-wrap">
        <table>
            ...
            <tbody>
            <?php if (!$submissions): ?>
                <tr><td colspan="4">No event submissions yet.</td></tr>
            <?php else: ?>
                <?php foreach ($submissions as $submission): ?>
                    <tr>
                        ...
                        <td><?= e(format_datetime($submission['submitted_at'], 'M j, Y H:i')); ?></td>
                        <td><a href="<?= e(base_url('/voter/register_event.php?event=' . $submission['event_id'])); ?>">Open</a></td>
                    </tr>
                <?php endforeach; ?>
            <?php endif; ?>
            </tbody>
    ...
    <article class="panel">
        ...
        <div class="list-shell">
            <div class="list-row">
                ...
                <a class="button button--primary" href="<?= e(base_url('/events.php')); ?>">Browse events</a>
            </div>
            <div class="list-row">
                <div>
            ...
            <div class="list-row">
                <div>
                    ...
                    <p>Confirm that your ballot was recorded correctly without exposing your identity.</p>
                </div>
